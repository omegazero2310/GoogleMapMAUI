...
using GGMapMAUI.Platforms.Android.Logics;
...
{
    public class MapRenderer : ViewRenderer<Maui.GoogleMaps.Map, global::Android.Views.View>,
       ...
       GoogleMap.IOnMyLocationButtonClickListener
    {
        ...
        // ReSharper disable once MemberCanBePrivate.Global
        protected Maui.GoogleMaps.Map Map => Element;
        ...
        protected override async void OnElementChanged(ElementChangedEventArgs<Maui.GoogleMaps.Map> e)
        {
            ...
            Maui.GoogleMaps.Map oldMap = null;
        ...
        protected virtual void OnMapReady(GoogleMap nativeMap, Maui.GoogleMaps.Map map)
        {
            if (nativeMap != null)
            {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Maui.GoogleMaps.Map.PaddingProperty.PropertyName)
            {
                SetPadding();
                return;
            }
            ...
            if (e.PropertyName == Maui.GoogleMaps.Map.IsShowingUserProperty.PropertyName)
            {
                UpdateIsShowingUser();
            }
...
#pragma warning restore 618
        ...
        private void Uninitialize(GoogleMap nativeMap, Maui.GoogleMaps.Map map)
        {
            try
            {
                if (nativeMap == null)
