...
namespace Maui.GoogleMaps
{
    public sealed class Polygon : BindableObject
    {
        ...
        public static readonly BindableProperty StrokeColorProperty = BindableProperty.Create(nameof(StrokeColor), typeof(Color), typeof(Polygon), Color.FromRgba(0, 0, 255, 0));
        public static readonly BindableProperty FillColorProperty = BindableProperty.Create(nameof(FillColor), typeof(Color), typeof(Polygon), Color.FromRgba(0, 0, 255, 0));
